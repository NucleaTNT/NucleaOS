...
class BitMap {
   public:
    ...
    /**
     * @brief Returns the state of the bit found at index.
     *
     * @param index Index of the bit to select. Ranges from [0.._size * 8]
     *
     * @return State of the bit at index. (true->set || false->unset)
    ...
    /**
     * @brief Sets the bit found at index to state.
     *
     * @param index Index of the bit to select. Ranges from [0.._size * 8]
     *
     ...
     * valid.
     */
    bool Set(uint64_t index, bool state);

    /**
     * @brief Get the size of the bitmap's buffer. Multiply this state by 8 to
