...
__attribute__((interrupt)) void handler_KeyboardInterrupt(InterruptFrame *frame);       // Interrupt Offset: 0x21
__attribute__((interrupt)) void handler_MouseInterrupt(InterruptFrame *frame);          // Interrupt Offset: 0x2c